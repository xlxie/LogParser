...
def log_parse(log_file_name):
	...
	while gite>1:
		...
		raw_data_dic[gite][report_metric_list[9]] = raw_data_dic[gite][report_metric_list[6]]/(raw_data_dic[gite][report_metric_list[6]]+0.1)
		gite = gite-1
	...
	raw_data_dic[gite][report_metric_list[9]] = raw_data_dic[gite][report_metric_list[6]]/(raw_data_dic[gite][report_metric_list[6]]+0.01)
	"""
	for ite1 in raw_data_dic.keys():
		print "ite1",ite1
		for ite2 in raw_data_dic[ite1].keys():
